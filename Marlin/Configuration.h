...
#define STRING_CONFIG_H_AUTHOR "Mauker (31/12/2022)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MEGA SKR-3-EZ"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -2, -25, -2.36 }
